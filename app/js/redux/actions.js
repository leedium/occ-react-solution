...
export const USER_PROFILE_UPDATE_SUCCESSFUL = "user.profile.update.successful.memory";
export const USER_PROFILE_PASSWORD_UPDATE_SUCCESSFUL = "user.profile.pwd.update.successful";
export const USER_PROFILE_PASSWORD_UPDATE_FAILURE = "user.profile.pwd.update.failure";
...
export const AUTO_LOGIN_AND_GET_USER_DATA_SUCCESSFUL = "auto.login.and.get.user.data.successful";
...
export const UPDATE_USER_LOCALE_NOT_SUPPORTED_ERROR = "update.user.locale.not.supported.error.memory";
...
export const FETCH_PURCHASE_LIST_AFTER_DELETE = "fetch.purchase.list.after.delete";
export const ADD_TO_PURCHASE_LIST = "add.to.purchase.list";
export const PRODUCT_ADDED_TO_PURCHASE_LIST_SUCCESS = "product.added.to.purchase.list.success";
