  ...
  function Index(props) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', render: function render(p) {
            return _react2.default.createElement(_Home2.default, _extends({}, p, { occProps: props.occProps }));
          } }),
        _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/dltest', render: function render(p) {
