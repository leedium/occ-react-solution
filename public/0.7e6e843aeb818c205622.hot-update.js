...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__("./node_modules/preact-compat/dist/preact-compat.es.js")], __WEBPACK_AMD_DEFINE_RESULT__ = function (module, exports, _react) {
  ...
  var DLTest = function (_Component) {
    ...
    function DLTest(props) {
      _classCallCheck(this, DLTest);

      var _this = _possibleConstructorReturn(this, (DLTest.__proto__ || Object.getPrototypeOf(DLTest)).call(this, props));
    ...
    _createClass(DLTest, [{
      ...
      value: function render() {
        var OCCLink = Components.OCCLink('cart', 'Hello', props.occProps.navigation);
