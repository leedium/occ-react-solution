  ...
  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(1), __webpack_require__(4), __webpack_require__(0), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function (ko, $, pubsub, ccConstants, navigation) {
    ...
    return {
      onLoad: function onLoad(widget) {
        ...
        _reactDom2.default.render(_react2.default.createElement(_index2.default, _extends({ pageName: 'TEST' }, dependencies)), document.getElementById('root'));
  ...
  var Index = function (_Component) {
    ...
    function Index() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (e) {
        ...
        _this.props.navigation.goTo(e.currentTarget.getAttribute('link'));
